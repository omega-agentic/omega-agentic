...
(() => {
  ...
  var evalQ = function(render12) {
    return function(ref2) {
      return function(q2) {
        return bind12(liftEffect3(read(ref2)))(function(v) {
          return evalM(render12)(ref2)(v["component"]["eval"](new Query(map13(Just.create)(liftCoyoneda(q2)), $$const(Nothing.value))));
        });
      };
    };
  };
                      ...
                      if (childrenIn instanceof Just) {
                        ...
                        unDriverStateX(function(st) {
                          return function __do3() {
                            ...
                            return handleAff(evalM(render12)(st.selfRef)(st["component"]["eval"](new Receive(slot.input, unit))))();
                          };
                        })(dsx)();
  ...
  // output/Straylight.Pages.OpenCode/index.js
  var routing = /* @__PURE__ */ section([/* @__PURE__ */ cls(["py-12 border-t border-border"])])([/* @__PURE__ */ sectionHeader("routing"), /* @__PURE__ */ p([/* @__PURE__ */ cls(["mb-6"])])([/* @__PURE__ */ keyword(1)("layer 1"), /* @__PURE__ */ text5(" \u2014 adversarial review, spec validation, test generation.")]), /* @__PURE__ */ div2([/* @__PURE__ */ cls(["grid grid-cols-[140px_1fr] gap-4 mb-4"])])([/* @__PURE__ */ span3([/* @__PURE__ */ cls(["text-muted-foreground"])])([/* @__PURE__ */ text5("gpt-5.2")]), /* @__PURE__ */ span_([/* @__PURE__ */ text5("nitpick. find flaws. be uncharitable.")])]), /* @__PURE__ */ div2([/* @__PURE__ */ cls(["grid grid-cols-[140px_1fr] gap-4 mb-8"])])([/* @__PURE__ */ span3([/* @__PURE__ */ cls(["text-muted-foreground"])])([/* @__PURE__ */ text5("o3-pro")]), /* @__PURE__ */ span_([/* @__PURE__ */ text5("heavy reasoning. formal spec derivation.")])]), /* @__PURE__ */ p([/* @__PURE__ */ cls(["mb-6"])])([/* @__PURE__ */ keyword(2)("layer 2"), /* @__PURE__ */ text5(" \u2014 creative coding, implementation, exploration.")]), /* @__PURE__ */ div2([/* @__PURE__ */ cls(["grid grid-cols-[140px_1fr] gap-4 mb-4"])])([/* @__PURE__ */ span3([/* @__PURE__ */ cls(["text-muted-foreground"])])([/* @__PURE__ */ text5("opus 4.5")]), /* @__PURE__ */ span_([/* @__PURE__ */ text5("primary. reliable workhorse.")])]), /* @__PURE__ */ div2([/* @__PURE__ */ cls(["grid grid-cols-[140px_1fr] gap-4 mb-4"])])([/* @__PURE__ */ span3([/* @__PURE__ */ cls(["text-muted-foreground"])])([/* @__PURE__ */ text5("gemini 3 pro")]), /* @__PURE__ */ span_([/* @__PURE__ */ text5("dark horse. gcp credits via openrouter.")])]), /* @__PURE__ */ div2([/* @__PURE__ */ cls(["grid grid-cols-[140px_1fr] gap-4"])])([/* @__PURE__ */ span3([/* @__PURE__ */ cls(["text-muted-foreground"])])([/* @__PURE__ */ text5("kimi k2.5")]), /* @__PURE__ */ span_([/* @__PURE__ */ text5("guest rotation. 9x cheaper.")])])]);
  var pricingRow = function(model) {
    return function(price) {
      return function(layer) {
        return div2([cls(["grid grid-cols-[140px_100px_1fr] gap-4 py-2 border-t border-border"])])([span3([cls(["text-text"])])([text5(model)]), span3([cls(["text-primary"])])([text5(price)]), span3([cls(["text-muted-foreground"])])([text5(layer)])]);
      };
    };
  };
  var pricing = /* @__PURE__ */ section([/* @__PURE__ */ cls(["py-12 border-t border-border"])])([/* @__PURE__ */ sectionHeader("pricing"), /* @__PURE__ */ div2([/* @__PURE__ */ cls(["grid grid-cols-[140px_100px_1fr] gap-4 mb-2 text-[0.85rem]"])])([/* @__PURE__ */ span3([/* @__PURE__ */ cls(["text-muted-foreground"])])([/* @__PURE__ */ text5("model")]), /* @__PURE__ */ span3([/* @__PURE__ */ cls(["text-muted-foreground"])])([/* @__PURE__ */ text5("$/M")]), /* @__PURE__ */ span3([/* @__PURE__ */ cls(["text-muted-foreground"])])([/* @__PURE__ */ text5("layer")])]), /* @__PURE__ */ pricingRow("opus 4.5")("$5/$25")("creative"), /* @__PURE__ */ pricingRow("kimi k2.5")("$0.50/$2.80")("creative"), /* @__PURE__ */ pricingRow("gemini 3")("$1.25/$10")("creative"), /* @__PURE__ */ pricingRow("gpt-5.2")("$1.25/$10")("nitpick"), /* @__PURE__ */ tip("Pure OpenRouter")([/* @__PURE__ */ p_([/* @__PURE__ */ text5("all models via openrouter. K2.5 is "), /* @__PURE__ */ strong_([/* @__PURE__ */ text5("9x cheaper")]), /* @__PURE__ */ text5(" than Opus. gemini burns gcp credits. one key, all models.")])])]);
  var phaseItem = function(n) {
    return function(name15) {
      return function(desc) {
        return div2([cls(["grid grid-cols-[100px_1fr] gap-4"])])([keyword(n)(name15), span_([text5(desc)])]);
      };
    };
  };
  var phases = /* @__PURE__ */ section([/* @__PURE__ */ cls(["py-12 border-t border-border"])])([/* @__PURE__ */ sectionHeader("phases"), /* @__PURE__ */ p([/* @__PURE__ */ cls(["mb-6 text-[0.9rem]"])])([/* @__PURE__ */ text5("every phase is reversible. no mutation without snapshot.")]), /* @__PURE__ */ div2([/* @__PURE__ */ cls(["flex flex-col gap-2"])])([/* @__PURE__ */ phaseItem(3)("snapshot")("capture current state (read-only)"), /* @__PURE__ */ phaseItem(4)("stage")("collect credentials, write staged config"), /* @__PURE__ */ phaseItem(5)("entry")("activate staged config (atomic)"), /* @__PURE__ */ phaseItem(6)("verify")("confirm activation, test connectivity"), /* @__PURE__ */ phaseItem(7)("abort")("full rollback to snapshot")]), /* @__PURE__ */ codeBlock([/* @__PURE__ */ inlineCode("# to undo"), /* @__PURE__ */ text5("\n"), /* @__PURE__ */ inlineCode("\u276F "), /* @__PURE__ */ code([/* @__PURE__ */ cls(["text-text"])])([/* @__PURE__ */ text5("curl -fsSL straylight.dev/opencode | sh -s abort")]), blockCursor])]);
  var install = /* @__PURE__ */ section([/* @__PURE__ */ cls(["py-12 border-t border-border"])])([/* @__PURE__ */ sectionHeader("install"), /* @__PURE__ */ codeBlock([/* @__PURE__ */ inlineCode("razorgirl on railgun ~"), /* @__PURE__ */ text5("\n"), /* @__PURE__ */ inlineCode("\u276F "), /* @__PURE__ */ code([/* @__PURE__ */ cls(["text-text"])])([/* @__PURE__ */ text5("curl -fsSL straylight.dev/opencode | sh")]), blockCursor]), /* @__PURE__ */ p([/* @__PURE__ */ cls(["mt-6 text-muted-foreground text-[0.9rem]"])])([/* @__PURE__ */ text5("phase-based installer with full rollback. every mutation is reversible.")])]);
  var hero2 = /* @__PURE__ */ section([/* @__PURE__ */ cls(["py-24 pb-16 text-right"])])([rail, /* @__PURE__ */ h1([/* @__PURE__ */ cls(["text-text text-[2rem] font-medium mt-6"])])([/* @__PURE__ */ span3([/* @__PURE__ */ cls(["text-primary"])])([/* @__PURE__ */ text5("//")]), /* @__PURE__ */ text5(" opencode "), /* @__PURE__ */ span3([/* @__PURE__ */ cls(["text-primary"])])([/* @__PURE__ */ text5("//")]), /* @__PURE__ */ text5(" pure openrouter "), /* @__PURE__ */ span3([/* @__PURE__ */ cls(["text-primary"])])([/* @__PURE__ */ text5("//")])]), /* @__PURE__ */ div2([/* @__PURE__ */ cls(["h-[3px] rail mt-6"])])([]), /* @__PURE__ */ p([/* @__PURE__ */ cls(["mt-12 text-left text-lg text-muted-foreground hover:text-text transition-colors duration-200 cursor-default"])])([/* @__PURE__ */ text5("nitpick \u2192 creative routing. burn gcp credits.")]), /* @__PURE__ */ p([/* @__PURE__ */ cls(["mt-6 text-left italic text-base02 text-[0.95rem] hover:text-text transition-colors duration-200 cursor-default"])])([/* @__PURE__ */ text5('"Get just what you paid for. Nothing more, nothing less."')])]);
  var render7 = /* @__PURE__ */ div_([hero2, install, routing, pricing, phases]);
  var openCodePage = /* @__PURE__ */ mkComponent({
    initialState: /* @__PURE__ */ $$const(unit),
  ...
  var OpenCode = /* @__PURE__ */ function() {
    function OpenCode2() {
    }
    ;
    OpenCode2.value = new OpenCode2();
    return OpenCode2;
  }();
    ...
    return function(v) {
      ...
      if (v instanceof RouteChanged) {
        return modify_6(function(v1) {
          ...
          ;
          $83.route = parseRoute(v.value0);
          return $83;
        });
      }
      ;
      throw new Error("Failed pattern match at Main (line 119, column 16 - line 135, column 44): " + [v.constructor.name]);
    };
  };
  ...
  var _opencode = /* @__PURE__ */ function() {
    return $$Proxy.value;
  }();
  ...
  var renderPage = function(dictMonadAff) {
    ...
    return function(v) {
      ...
      ;
      if (v instanceof OpenCode) {
        return slot_9(_opencode)(unit)(openCodePage)(unit);
      }
      ;
      throw new Error("Failed pattern match at Main (line 161, column 14 - line 169, column 65): " + [v.constructor.name]);
    };
  };
  var render11 = function(dictMonadAff) {
    ...
    return function(state3) {
      return div2([cls(["min-h-screen bg-background text-muted-foreground text-[15px] leading-relaxed"])])([scanlineOverlay, renderHeader1(state3), main([cls(["max-w-[900px] mx-auto px-8 py-12"])])([renderPage1(state3.route)]), slot_10(_footer)(unit)(footer3)(unit)]);
    };
  };
  ...
  var main2 = /* @__PURE__ */ launchAff_(/* @__PURE__ */ discard6(bindAff)(awaitLoad)(function() {
    return bind15(liftEffect6(bind22(windowImpl)(document2)))(function(doc) {
      ...
      return bind15(liftEffect6(querySelector("#straylight-app")(parent2)))(function(mbContainer) {
        ...
        ;
        throw new Error("Failed pattern match at Main (line 50, column 3 - line 52, column 63): " + [v.constructor.name]);
      });
    });
  }));
